...
var endGame = function() {
  ...
  // if player has mire money than the high score, player has a new high score
  ...
  if (playAgainConfirm) {
      ...
      window.alert("Thank you for playing Robot Gladiators Two! Y'all come back now yah hear!");
  }
};
